public class Documentation {
    ...
    public static void docs(){
        ...
        System.out.println("The Casino class instantiates a player who immediately rolls 2 dice and holds those values internally. " +
                "The Casino calls the factory method in the Dealer class with the player as an argument. " +
        ...
        System.out.println("");
        System.out.println("This value initializes at 0 and is passed, along with the Hand instance, into a factory method within the Rulebook class, gameRules. " +
                ...
                "The Dealer class' factory method, reportLuck, recieves the output of gameRules, and knows to either send a similar int signal to the Casino class to inform it that the game is over and whether the player has won or not, or to repeat the game by way of a do-while loop. ");
        System.out.println("");
